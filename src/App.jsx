...
const OMNI26_ICON = "data:image/png;base64,";
...
// ── Dropdown customizado de seleção de cliente (tela de resultados) ──────────
function ClienteDropdown({ clientes, clienteSelecionado, onSelect, onClear }) {
  ...
  const filtrados = clientes.filter(c => {
    ...
    return !s || (c.nome||'').toLowerCase().includes(s) || (c.empresa||'').toLowerCase().includes(s);
  });
    ...
    <div ref={ref} style={{position: 'relative', minWidth: 300}}>
      ...
      <div
        ...
        style={{
          ...
          border: clienteSelecionado ? '1px solid #f97316' : '1px solid #eab308',
          background: 'rgba(0,0,0,0.55)', color: '#f1f5f9',
          fontSize: 13, fontWeight: clienteSelecionado ? 600 : 400,
      ...
      >
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0}}>
          {clienteSelecionado && (
            <span
              onClick={(e) => { e.stopPropagation(); onClear(); setBusca(''); setOpen(false); }}
              style={{
                background: 'rgba(239,68,68,0.18)', border: '1px solid rgba(239,68,68,0.35)',
                color: '#ef4444', borderRadius: 6, padding: '2px 8px',
                fontSize: 12, cursor: 'pointer', fontWeight: 700, lineHeight: 1.4,
              }}
            >✕</span>
          )}
      ...
      {open && (
        <div style={{
          ...
          background: '#0f172a', border: '1px solid rgba(249,115,22,0.35)',
          ...
          <div style={{overflowY: 'auto', maxHeight: 210}}>
            {/* Opção limpar */}
            <div
              onClick={() => { onSelect(null); setBusca(''); setOpen(false); }}
              style={{
                padding: '9px 14px', fontSize: 13, color: '#94a3b8',
            ...
            {filtrados.length > 0 ? filtrados.map(c => (
              <div
                key={c.id}
                onClick={() => { onSelect(c); setBusca(''); setOpen(false); }}
                style={{
                  padding: '10px 14px', fontSize: 13, cursor: 'pointer',
                  color: clienteSelecionado?.id === c.id ? '#f97316' : '#e2e8f0',
                  background: clienteSelecionado?.id === c.id ? 'rgba(249,115,22,0.08)' : 'transparent',
                  borderBottom: '1px solid rgba(255,255,255,0.03)',
                  fontWeight: clienteSelecionado?.id === c.id ? 700 : 400,
                  whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                }}
                onMouseEnter={e => { if (clienteSelecionado?.id !== c.id) e.currentTarget.style.background = 'rgba(255,255,255,0.06)'; }}
                onMouseLeave={e => { if (clienteSelecionado?.id !== c.id) e.currentTarget.style.background = 'transparent'; }}
              >
                <span style={{fontWeight: 600}}>{c.nome}</span>
                {c.empresa && <span style={{color: '#64748b', fontSize: 11, marginLeft: 6}}>({c.empresa})</span>}
              </div>
            )) : (
              <div style={{padding: '14px', fontSize: 13, color: '#475569', textAlign: 'center'}}>
...
// --- ESTADO DO DASHBOARD FINANCEIRO ---
  ...
  const [sysLogos, setSysLogos] = useState(() => {
    ...
    return {
      login: OMNI26_DEFAULT_LOGO,
      sidebar: OMNI26_DEFAULT_LOGO,
      pdf: OMNI26_DEFAULT_LOGO
    };
  });
...
// --- FUNÇÕES DE EDIÇÃO INDIVIDUAL (CONTAS A PAGAR) ---
  ...
  useEffect(() => { 
    if (isLoggedIn) { 
      ...
      loadUsers(); 
      loadFornecedores();
      loadClientes(); // Carrega clientes para o seletor na tela de resultados
      loadDashFin();
    } 
  }, [isLoggedIn]);
